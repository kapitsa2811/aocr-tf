...
class Seq2SeqModel(object):
    ...
    def __init__(self, encoder_masks, encoder_inputs_tensor,
        ...
        def seq2seq_f(lstm_inputs, decoder_inputs, seq_length, do_decode):
            ...
            # attention_states = tf.Print(attention_states,
            #                             [tf.shape(attention_states), tf.shape(top_states), tf.shape(initial_state), attention_states], "AS: ",
            #                             summarize=10)
